            ...
            <article className="max-w-4xl mx-auto">
                ...
                >
                    ...
                    <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6 mb-10">
                        {project.github_url && (
                            <a href={project.github_url} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-[var(--text-muted)] hover:text-[var(--text-color)] bg-[var(--card-bg)] border border-[var(--border-color)] px-6 py-3 rounded-full transition-colors shadow-sm hover:shadow-md w-full sm:w-auto justify-center">
                        ...
                        {project.project_url && (
                            <a href={project.project_url} target="_blank" rel="noopener noreferrer" className="flex items-center space-x-2 text-black bg-primary hover:bg-secondary px-6 py-3 rounded-full transition-colors shadow-md hover:shadow-lg font-bold w-full sm:w-auto justify-center">
